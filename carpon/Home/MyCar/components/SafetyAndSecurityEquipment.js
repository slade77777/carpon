...
export class SafetyAndSecurityEquipment extends Component {
    ...
    handleCarField() {
        ...
        const CarField = [
            'equiment_reduction',
            'equiment_mitigation',
            'equipment_driving_support',
            'vehicle',
            'equipment_lane_departure_prevention',
            'equipment_packing_support',
            'equipment_visibility_support',
            'equipment_satefy'
        ];
        ...
        return (
            <View style={{backgroundColor: '#FFF'}}>
                <View style={{
                    ...
                    <Text style={{color: '#262525', fontSize: 17, fontWeight: 'bold'}}>安全・安心装備</Text>
                </View>
