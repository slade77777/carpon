...
import {updateProfile} from "../actions/inspectionAction";
...
@screen('UpdateUserInspection', {header: <HeaderOnPress title={'送信内容の修正'}/>})
@connect(
    state => ({
...
export class UpdateUserInspection extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        viewPage('edit_car_inspection_reservation_user', '車検予約ユーザ情報編集');
    }
