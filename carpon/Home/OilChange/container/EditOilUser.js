...
import {settingOilTime} from "../actions/oilAction";
...
@screen('EditOilUser', {header: <HeaderOnPress title='オイル交換予約'/>})
@connect(state => ({
...
export class EditOilUser extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            first_date: props.oilTime.first_date,
            first_date_time: props.oilTime.first_date_time,
            second_date: props.oilTime.second_date,
            second_date_time: props.oilTime.second_date_time,
            isChooseFirst: null,
            loading: false,
        };
    }
    ...
    componentDidMount() {
        viewPage('edit_oil_exchange_reservation_date', 'オイル交換予約日時編集');
    }
